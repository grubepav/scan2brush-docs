...
=== "Windows / Linux"
    ...
    2. Go to **Edit → Preferences**.  
       ![Preferences](img/blender_preferences.png)

    3. Select **Add-ons**.  
       ![Add-ons panel](img/blender_addons_panel.png)

    4. Click **Install…**.  
       ![Install add-on](img/blender_addons_install.png)

    5. Select the downloaded `scan2brush.zip`.  
       ![Select scan2brush.zip](img/scan2brush_install.png)

       Blender will install the add-on automatically.

    6. Search for `scan2brush`.  
       ![Search for scan2brush](img/scan2brush_search.png)

    7. Enable the add-on.  
       ![Enable add-on](img/scan2brush_activate.png)

    8. After enabling, the **Scan2brusH panel appears in the right-hand sidebar**.  
       ![Add-on enabled](img/scan2brush_enabled.png)
